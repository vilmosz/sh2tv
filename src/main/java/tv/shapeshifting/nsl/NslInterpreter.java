...
public class NslInterpreter {
	public enum State {INITIALIZED, INTERPRETING, WAITING, FINISHED, UNKNOWN}
	...
	public int interpret() throws IOException, UnexpectedNarrativeObjectException, InterruptedException {
