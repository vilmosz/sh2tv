...
<body onload="javascript:agaLoad();" >
	...
	<form id="form_engine" name="form_engine" onsubmit="">
		<select name="owl" id="select_owl" hidden="true">
			<option value="owl=ontology/production/nm2.aga.nsl.ttl&rules=ontology/production/nm2.aga.static.rule&rules=ontology/production/nm2.aga.dynamic.rule">A Golden Age</option>
		</select>
